f.val.calc.Delta.from.ratios.in.out <-
...
{
  ##details<<
  ## First calculates R.ref and R.cham with \code{\link{f.val.calc.isotope.ratio}}
  R.ref  <- f.val.calc.isotope.ratio(ref.12Ce, ref.13Ce);
