...
{
  ##details<<
  ## See \code{\link{val.TDL.Licor.variables}} for expected column names.
  ...
  if (sw$use.TDL  ) {
    ...
    TDL$ind             <- 1:TDL$n;  # moved from interp.TDL.tanks.ref.R 8/18/2011 10:50AM
    # time
