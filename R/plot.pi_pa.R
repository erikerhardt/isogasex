...
)
{
  ...
  for (i.plot in plot.format.list)
  {
    ...
    plot.not.na(x.time, chamber.Totalpi_pa, pch=20, type="l", ylab="", main="Total pi/pa, ratio of substomatal CO2 partial pressure to CO2 partial pressure above leaf");
