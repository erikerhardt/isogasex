...
)
{
  ...
  for (i.plot in plot.format.list)
  {
    ...
    plot.not.na(x.time, chamber.TotalCc, pch=20, type="l", ylab="", main="Total Cc, ppm CO2 concentration at the site of carboxylation");
    plot.not.na(x.time, chamber.12Cc   , pch=20, type="l", ylab="", main="12 Cc, ppm CO2 concentration at the site of carboxylation");
    plot.not.na(x.time, chamber.13Cc   , pch=20, type="l", ylab="", main="13 Cc, ppm CO2 concentration at the site of carboxylation");
