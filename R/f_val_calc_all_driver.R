...
)
{
  ...
  temp.gain <-
    f_val_calc_gain( val.const$true.value.hi.12C, val.const$true.value.hi.13C, val.const$true.value.lo.12C, val.const$true.value.lo.13C
  ...
  temp.offset <-
    f_val_calc_offset( val.const$true.value.hi.12C, val.const$true.value.hi.13C
  ...
  #plot_gain_offset(val.temp$gain.12C, val.temp$gain.13C, val.temp$offset.12C, val.temp$offset.13C, val.TDL$time, plot.format.list);
  ...
  temp.corrected <-
    f_val_calc_corrected(val.TDL$interp.reference.12, val.TDL$interp.reference.13
                        ,val.temp$gain.12C, val.temp$gain.13C
  ...
  temp.corrected <-
    f_val_calc_corrected(val.TDL$chamber.12, val.TDL$chamber.13
                        ,val.temp$gain.12C, val.temp$gain.13C
                        ,val.temp$offset.12C, val.temp$offset.13C)
  ...
  val.temp$reference.TotalCe <-
    f_val_calc_total_mol_fraction_CO2(val.temp$reference.12Ce, val.temp$reference.13Ce, val.const$fo.13C);
  val.temp$chamber.TotalCo   <-
    f_val_calc_total_mol_fraction_CO2(val.temp$chamber.12Co, val.temp$chamber.13Co, val.const$fo.13C);
  ...
  val.temp$xi <-
    f_val_calc_xi(val.temp$reference.TotalCe, val.temp$chamber.TotalCo)
  ...
  #  f_val_calc_flow_adjusted(val.Licor$uin, val.Licor$xin);  # 9/5/2012

  ##details<<
  ## A, TDL photosynthesis. \code{\link{f_val_calc_TDL_A_photosynthesis}}
  val.temp$TDL.A.photosynthesis <-
    #f_val_calc_TDL_A_photosynthesis( val.temp$flow.adjusted, val.temp$reference.TotalCe  # 9/5/2012
    f_val_calc_TDL_A_photosynthesis( val.temp$Licor.flow.uin, val.temp$reference.TotalCe  # 9/5/2012
  ...
  val.temp$TDL.12A.photosynthesis <-
    #f_val_calc_TDL_A_photosynthesis( val.temp$flow.adjusted, val.temp$reference.12Ce  # 9/5/2012
    f_val_calc_TDL_A_photosynthesis( val.temp$Licor.flow.uin, val.temp$reference.12Ce  # 9/5/2012
  ...
  val.temp$TDL.13A.photosynthesis <-
    #f_val_calc_TDL_A_photosynthesis( val.temp$flow.adjusted, val.temp$reference.13Ce  # 9/5/2012
    f_val_calc_TDL_A_photosynthesis( val.temp$Licor.flow.uin, val.temp$reference.13Ce  # 9/5/2012
  ...
  val.temp$Delta.from.ratios.in.out <-
    f_val_calc_Delta_from_ratios_in_out( val.temp$reference.12Ce, val.temp$reference.13Ce
                                        ,val.temp$chamber.12Co,   val.temp$chamber.13Co)
  ...
  val.temp$Delta.from.A.ratio <-
    f_val_calc_Delta_from_A_ratio( val.temp$chamber.12Co, val.temp$chamber.13Co
  ...
  val.temp$reference.delta.e <-
    f_val_calc_delta_proportion(val.temp$reference.12Ce, val.temp$reference.13Ce, val.const$Rstd.13C);
    # do  d13C Site 21
  val.temp$chamber.delta.o   <-
    f_val_calc_delta_proportion(val.temp$chamber.12Co, val.temp$chamber.13Co, val.const$Rstd.13C);
  ...
  val.temp$Delta.obs <-
    f_val_calc_Delta_obs(val.temp$reference.delta.e, val.temp$chamber.delta.o, val.temp$xi)
  ##details<<
  ## Dobs per mil  1000*Dobs. \code{\link{f_val_calc_Delta_obs_permil}}
  val.temp$Delta.obs.permil <-
    f_val_calc_Delta_obs_permil(val.temp$reference.delta.e, val.temp$chamber.delta.o, val.temp$xi)
  ...
  val.temp$delta.13C.Assim <-
    f_val_calc_delta_13C_Assim(val.temp$chamber.delta.o, val.temp$Delta.obs)

  ##details<<
  ## p (Co - Ce) / Co. \code{\link{f_val_calc_p}}
  val.temp$p <-
    f_val_calc_p(val.temp$reference.TotalCe, val.temp$chamber.TotalCo)

  ##details<<
  ## delta13C Respired, isotopic composition of respired CO2. \code{\link{f_val_calc_delta_13C_Resp}}
  val.temp$delta.13C.Resp <-
    f_val_calc_delta_13C_Resp(val.temp$reference.delta.e, val.temp$chamber.delta.o, val.temp$p)
  ...
  val.temp$chamber.Totalgtc <- f_val_calc_gtc( val.temp$chamber.Totalgbc, val.temp$chamber.Totalgsc);
  val.temp$chamber.12gtc    <- val.temp$chamber.Totalgtc;
  val.temp$chamber.13gtc    <- f_val_calc_gtc( val.temp$chamber.13gbc, val.temp$chamber.13gsc);
  ...
  #val.temp$chamber.TotalCs <- f_val_calc_Cs(val.Licor$gbw, val.Licor$E, val.temp$chamber.TotalCo, val.temp$TDL.A.photosynthesis);
  #val.temp$chamber.12Cs    <- f_val_calc_Cs(val.Licor$gbw, val.Licor$E, val.temp$chamber.12Co   , val.temp$TDL.A.photosynthesis);
  #val.temp$chamber.13Cs    <- f_val_calc_Cs(val.Licor$gbw, val.Licor$E, val.temp$chamber.13Co   , val.temp$TDL.A.photosynthesis);
  ...
  val.temp$chamber.TotalCs <- f_val_calc_Cs(val.temp$chamber.Totalgbc, val.Licor$E, val.temp$chamber.TotalCo, val.temp$selected.A.photosynthesis);
  val.temp$chamber.12Cs    <- f_val_calc_Cs(val.temp$chamber.12gbc   , val.Licor$E, val.temp$chamber.12Co   , val.temp$selected.12A.photosynthesis);
  val.temp$chamber.13Cs    <- f_val_calc_Cs(val.temp$chamber.13gbc   , val.Licor$E, val.temp$chamber.13Co   , val.temp$selected.13A.photosynthesis);
  ...
  val.temp$chamber.Totalpa <- f_val_calc_pp(val.temp$chamber.TotalCo, val.Licor$Atm.press);
  val.temp$chamber.12pa    <- f_val_calc_pp(val.temp$chamber.12Co   , val.Licor$Atm.press);
  val.temp$chamber.13pa    <- f_val_calc_pp(val.temp$chamber.13Co   , val.Licor$Atm.press);
  ...
  val.temp$chamber.Totalps <- f_val_calc_pp(val.temp$chamber.TotalCs, val.Licor$Atm.press);
  val.temp$chamber.12ps    <- f_val_calc_pp(val.temp$chamber.12Cs   , val.Licor$Atm.press);
  val.temp$chamber.13ps    <- f_val_calc_pp(val.temp$chamber.13Cs   , val.Licor$Atm.press);
  ...
  #val.temp$chamber.TotalCi <- f_val_calc_Cs(val.temp$chamber.Totalgtc, val.Licor$E, val.temp$chamber.TotalCo, val.temp$TDL.A.photosynthesis);
  #val.temp$chamber.12Ci    <- f_val_calc_Cs(val.temp$chamber.12gtc,    val.Licor$E, val.temp$chamber.12Co   , val.temp$TDL.A.photosynthesis);
  #val.temp$chamber.13Ci    <- f_val_calc_Cs(val.temp$chamber.13gtc,    val.Licor$E, val.temp$chamber.13Co   , val.temp$TDL.A.photosynthesis);
  # 7/28/2012 Using A from Licor until test effect of using A from TDL
  # switch added for A.photosynthesis 9/5/2012
  val.temp$chamber.TotalCi <- f_val_calc_Cs(val.temp$chamber.Totalgtc, val.Licor$E, val.temp$chamber.TotalCo, val.temp$selected.A.photosynthesis);
  val.temp$chamber.12Ci    <- f_val_calc_Cs(val.temp$chamber.12gtc,    val.Licor$E, val.temp$chamber.12Co   , val.temp$selected.12A.photosynthesis);
  val.temp$chamber.13Ci    <- f_val_calc_Cs(val.temp$chamber.13gtc,    val.Licor$E, val.temp$chamber.13Co   , val.temp$selected.13A.photosynthesis);
  ...
  val.temp$chamber.Totalpi <- f_val_calc_pp(val.temp$chamber.TotalCi, val.Licor$Atm.press);
  val.temp$chamber.12pi    <- f_val_calc_pp(val.temp$chamber.12Ci   , val.Licor$Atm.press);
  val.temp$chamber.13pi    <- f_val_calc_pp(val.temp$chamber.13Ci   , val.Licor$Atm.press);
  ...
  ##details<<
  ## Delta.i simple for gm, predicted discrimination including boundary layer effects but not decarboxylation effects. \code{\link{f_val_calc_Delta_i_simple_for_gm}}
  val.temp$chamber.Delta.i.simple.for.gm <-
    f_val_calc_Delta_i_simple_for_gm( val.const$a, val.const$b.gm, val.const$a.b
                                     ,val.temp$chamber.Totalpa, val.temp$chamber.Totalps, val.temp$chamber.Totalpi)

  ##details<<
  ## Delta.i simple for modeling  a + (b-a) pi/pa predicted discrimination including boundary layer effects but using b adjustments to approximate effects of gm and decarboxylations. \code{\link{f_val_calc_Delta_i_simple_for_modeling}}
  val.temp$chamber.Delta.i.simple.for.modeling <-
    f_val_calc_Delta_i_simple_for_modeling( val.const$a, val.const$b.modeling
                                     ,val.temp$chamber.Totalpa, val.temp$chamber.Totalpi)

  ##details<<
  ## Delta.i complex for gm  CHECK DERIVATION  predicted discrimination including boundary layer effects AND decarboxylation effects. \code{\link{f_val_calc_Delta_i_complex_for_gm}}
  val.temp$chamber.Delta.i.complex.for.gm <-
    f_val_calc_Delta_i_complex_for_gm( val.const$a, val.const$b.gm, val.const$a.b
                                      ,val.temp$chamber.Totalpa, val.temp$chamber.Totalps, val.temp$chamber.Totalpi
                                      ,val.const$b.gm
  ...
  val.temp$chamber.Totalgm.point.simple <-
    # switch added for A.photosynthesis 9/5/2012
    #f_val_calc_gm_point_simple( val.const$b.gm, val.const$b.s, val.const$a.l, val.Licor$A
    f_val_calc_gm_point_simple( val.const$b.gm, val.const$b.s, val.const$a.l, val.temp$selected.A.photosynthesis
  ...
  val.temp$chamber.12gm.point.simple <-
    f_val_calc_gm_point_simple( val.const$b.gm, val.const$b.s, val.const$a.l, val.temp$selected.12A.photosynthesis
                               ,val.temp$chamber.12pa, val.temp$chamber.Delta.i.simple.for.gm, val.temp$Delta.obs.permil);
  val.temp$chamber.13gm.point.simple <-
    # switch added for A.photosynthesis 9/5/2012
    #f_val_calc_gm_point_simple( val.const$b.gm, val.const$b.s, val.const$a.l, val.temp$TDL.13A.photosynthesis
    f_val_calc_gm_point_simple( val.const$b.gm, val.const$b.s, val.const$a.l, val.temp$selected.13A.photosynthesis
  ...
  val.temp$chamber.Totalgm.point.complex <-
    # switch added for A.photosynthesis 9/5/2012
    #f_val_calc_gm_point_complex( val.const$b.gm, val.const$b.s, val.const$a.l, val.Licor$A
    f_val_calc_gm_point_complex( val.const$b.gm, val.const$b.s, val.const$a.l, val.temp$selected.A.photosynthesis
  ...
  ## pc using gm,  total partial pressure of CO2 at the site of carboxylation, Press is the atmospheric pressure value from the LI6400. \code{\link{f_val_calc_pc_using_gm}}
    # switch added for A.photosynthesis 9/5/2012
  #val.temp$chamber.Totalpc.using.gm <- f_val_calc_pc_using_gm(val.temp$chamber.Totalpi, val.Licor$A, val.temp$chamber.Totalgm.to.use);
  #val.temp$chamber.12pc.using.gm    <- f_val_calc_pc_using_gm(val.temp$chamber.12pi   , val.Licor$A, val.temp$chamber.Totalgm.to.use);
  #val.temp$chamber.13pc.using.gm    <- f_val_calc_pc_using_gm(val.temp$chamber.13pi   , val.Licor$A, val.temp$chamber.Totalgm.to.use);
  val.temp$chamber.Totalpc.using.gm <- f_val_calc_pc_using_gm(val.temp$chamber.Totalpi, val.temp$selected.A.photosynthesis, val.temp$chamber.Totalgm.to.use);
  val.temp$chamber.12pc.using.gm    <- f_val_calc_pc_using_gm(val.temp$chamber.12pi   , val.temp$selected.12A.photosynthesis, val.temp$chamber.Totalgm.to.use);
  val.temp$chamber.13pc.using.gm    <- f_val_calc_pc_using_gm(val.temp$chamber.13pi   , val.temp$selected.13A.photosynthesis, val.temp$chamber.Totalgm.to.use);
  ...
  val.temp$chamber.Totalpc.using.simple.Delta.for.gm <-
    f_val_calc_pc_using_simple_Delta_for_gm( val.temp$chamber.Delta.i.simple.for.gm, val.temp$chamber.Totalpa
  ...
  val.temp$chamber.Totalpc.using.simple.Delta.for.modeling <-
    f_val_calc_pc_using_simple_Delta_for_modeling( val.temp$chamber.Delta.i.simple.for.modeling, val.temp$chamber.Totalpa
  ...
  val.temp$chamber.Totalpc.using.complex.Delta.no.decarboxylation <-
    f_val_calc_pc_using_complex_Delta_no_decarboxylation( val.temp$chamber.Delta.i.complex.for.gm, val.temp$chamber.Totalpa
  ...
  val.temp$chamber.Totalpc.using.complex.Delta.full.model <-
    f_val_calc_pc_using_complex_Delta_full_model( val.temp$chamber.Delta.i.complex.for.gm, val.temp$chamber.Totalpa
                                                 ,val.temp$chamber.Totalps, val.temp$chamber.Totalpi
                                                 ,val.const$a, val.const$a.b, val.const$a.l, val.const$b.modeling, val.const$b.s
  ...
  val.temp$chamber.TotalCc <- f_val_calc_pp(val.temp$chamber.Totalpc.using.gm, val.Licor$Atm.press);
  val.temp$chamber.12Cc    <- f_val_calc_pp(val.temp$chamber.12pc.using.gm   , val.Licor$Atm.press);
  val.temp$chamber.13Cc    <- f_val_calc_pp(val.temp$chamber.13pc.using.gm   , val.Licor$Atm.press);
