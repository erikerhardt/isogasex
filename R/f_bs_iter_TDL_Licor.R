...
)
{
  ...
  val.bs.sum$TDL$conc12CO2             <- f_np_bs_mean (val.obs.TDL$conc12CO2          , val.bs.sum$TDL$first.ind, val.bs.sum$TDL$ind, val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$conc13CO2             <- f_np_bs_mean (val.obs.TDL$conc13CO2          , val.bs.sum$TDL$first.ind, val.bs.sum$TDL$ind, val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$TGApressure           <- f_np_bs_mean (val.obs.TDL$TGApressure        , val.bs.sum$TDL$first.ind, val.bs.sum$TDL$ind, val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$MassFlow1             <- f_np_bs_mean (val.obs.TDL$MassFlow1          , val.bs.sum$TDL$first.ind, val.bs.sum$TDL$ind, val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$Pressure1             <- f_np_bs_mean (val.obs.TDL$Pressure1          , val.bs.sum$TDL$first.ind, val.bs.sum$TDL$ind, val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$MassFlow2             <- f_np_bs_mean (val.obs.TDL$MassFlow2          , val.bs.sum$TDL$first.ind, val.bs.sum$TDL$ind, val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$Pressure2             <- f_np_bs_mean (val.obs.TDL$Pressure2          , val.bs.sum$TDL$first.ind, val.bs.sum$TDL$ind, val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$PressureProMan        <- f_np_bs_mean (val.obs.TDL$PressureProMan     , val.bs.sum$TDL$first.ind, val.bs.sum$TDL$ind, val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$interp.tank.hi.12     <- f_par_bs_mean(val.sum.TDL$interp.tank.hi.12  , var.interp$tank.hi.12   , val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$interp.tank.hi.13     <- f_par_bs_mean(val.sum.TDL$interp.tank.hi.13  , var.interp$tank.hi.13   , val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$interp.tank.low.12    <- f_par_bs_mean(val.sum.TDL$interp.tank.low.12 , var.interp$tank.low.12  , val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$interp.tank.low.13    <- f_par_bs_mean(val.sum.TDL$interp.tank.low.13 , var.interp$tank.low.13  , val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$interp.reference.12   <- f_par_bs_mean(val.sum.TDL$interp.reference.12, var.interp$reference.12 , val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$interp.reference.13   <- f_par_bs_mean(val.sum.TDL$interp.reference.13, var.interp$reference.13 , val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$chamber.12            <- f_np_bs_mean (val.obs.TDL$chamber.12         , val.bs.sum$TDL$first.ind, val.bs.sum$TDL$ind, val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
  val.bs.sum$TDL$chamber.13            <- f_np_bs_mean (val.obs.TDL$chamber.13         , val.bs.sum$TDL$first.ind, val.bs.sum$TDL$ind, val.bs.sum$TDL$n.sam, val.bs.sum$TDL$n);
